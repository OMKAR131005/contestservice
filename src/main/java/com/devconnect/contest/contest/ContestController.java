...
public class ContestController {
    ...
    @PostMapping
    public ContestResponseDTO createContest(@AuthenticationPrincipal Long userId,
    ...
    @GetMapping
    public List<ContestResponseDTO> getVisibleContests(@AuthenticationPrincipal Long userId) {
        return contestService.getVisibleContests(userId);
    }

    // GET /api/contests/{id} — single contest, with private-contest access check
    @GetMapping("/{id}")
    public ContestResponseDTO getContestById(@AuthenticationPrincipal Long userId,
    ...
    public List<ContestResponseDTO> getMyInvitations(@AuthenticationPrincipal Long userId) {
